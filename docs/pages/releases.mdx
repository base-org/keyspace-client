...
Keyspace v0.0.3 is the first smart contract-based implementation of Keyspace. The dedicated keystore rollup has been removed. Keyspace keystores are now stored in the smart wallet contracts themselves. This release supports OP Stack L2s only.
